...
par exemple je veux justifier le texte suivant avec une longueur de 30 caractères par ligne :
 ```
...
```
![Settings Window](https://github.com/fou65ad/tictactrip-justify-REST-API/blob/master/screenshots/Screenshot%20from%202018-11-11%2003-59-31.png)
